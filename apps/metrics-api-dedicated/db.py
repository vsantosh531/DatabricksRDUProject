# Intentionally duplicated from apps/metrics-api-generic/db.py — Databricks
# Apps upload one directory each with no cross-app imports at runtime, and
# these two apps are meant to be independently deployable. Keep in sync by
# hand if the connection pattern ever changes.
import os
